...
const (
	...
	Calculator_GetTaskResult_FullMethodName = "/calculator.Calculator/GetTaskResult"
)
...
type CalculatorClient interface {
	...
	SubmitResult(ctx context.Context, in *Result, opts ...grpc.CallOption) (*ResultResponse, error)
...
func (c *calculatorClient) SubmitResult(ctx context.Context, in *Result, opts ...grpc.CallOption) (*ResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *calculatorClient) GetTaskResult(ctx context.Context, in *TaskResultRequest, opts ...grpc.CallOption) (*TaskResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TaskResultResponse)
	err := c.cc.Invoke(ctx, Calculator_GetTaskResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	...
	SubmitResult(context.Context, *Result) (*ResultResponse, error)
...
func (UnimplementedCalculatorServer) SubmitResult(context.Context, *Result) (*ResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitResult not implemented")
}
func (UnimplementedCalculatorServer) GetTaskResult(context.Context, *TaskResultRequest) (*TaskResultResponse, error) {
...
func _Calculator_GetTaskResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServer).GetTaskResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Calculator_GetTaskResult_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).GetTaskResult(ctx, req.(*TaskResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Calculator_GetTaskResult_Handler,
		},
	},
